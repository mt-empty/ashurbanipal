 ...
 * consumer would: add the dependency, set `ashurbanipal.*` config, done —
 * no code beyond this. Plays the same role
 * `implementations/rust/axum/examples/demo.rs` plays for the Rust
